...
//
//public class MCTSRootParallelization_ extends MCTS {
//    private final Logger logger = Logger.getLogger(MCTSImpl_.class.getName());
//
//    private final List<AbstractMCTS> mctsInstances;
//    private final ExecutorService threadPool;
//
//    public MCTSRootParallelization_(Supplier<AbstractMCTS> mctsFactory, int numberOfCores) {
...
//    }
//
//    public MCTSRootParallelization_(Supplier<AbstractMCTS> mctsFactory) {
